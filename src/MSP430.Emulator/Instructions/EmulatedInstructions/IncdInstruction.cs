...
/// <summary>
/// Implements the MSP430 INCD (Increment by 2) emulated instruction.
/// 
/// The INCD instruction increments the destination operand by 2.
/// This instruction is emulated as ADD(.B) #2, dst per SLAU445I Table 4-7.
/// 
/// Operation: dst = dst + 2
...
/// </summary>
public class IncdInstruction : Instruction, IExecutableInstruction
{
    ...
    /// <summary>
    /// Initializes a new instance of the IncdInstruction class.
    /// </summary>
    ...
    /// <summary>
    /// Gets the mnemonic for the INCD instruction.
    /// </summary>
    public override string Mnemonic => _isByteOperation ? "INCD.B" : "INCD";

    /// <summary>
    /// Executes the INCD instruction on the specified CPU state.
    /// This emulates ADD #2, dst to increment the destination by 2.
    /// </summary>
    ...
    public uint Execute(IRegisterFile registerFile, byte[] memory, ushort[] extensionWords)
    {
        ...
        // INCD dst is emulated as ADD #2, dst
