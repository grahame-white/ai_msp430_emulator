...
/// <summary>
/// Represents the MSP430 BIS instruction.
/// 
/// The BIS instruction performs a bitwise OR operation between the source and destination operands.
/// The result is stored in the destination operand. BIS stands for "Bit Set".
/// Format: BIS src, dst
...
/// 
/// References:
/// - MSP430 Assembly Language Tools User's Guide (SLAU131), Section 5.3.2: "BIS - Bit Set" - Instruction format and operation
...
/// </summary>
public class BisInstruction : LogicalInstruction
{
    /// <summary>
    ...
    public BisInstruction(
        ...
        : base(0xD, instructionWord, sourceRegister, destinationRegister, sourceAddressingMode, destinationAddressingMode, isByteOperation)
    {
    }

    /// <summary>
    /// Gets the base mnemonic for the BIS instruction.
    /// </summary>
    protected override string BaseMnemonic => "BIS";

    /// <summary>
    /// Performs the BIS (bit set) logical operation.
    /// </summary>
