...
public class BisInstruction : Instruction, IExecutableInstruction
{
    ...
    public BisInstruction(
        ...
        : base(InstructionFormat.FormatI, 0xD, instructionWord)
    {
    ...
    /// <summary>
    /// Gets the mnemonic for the BIS instruction.
    /// </summary>
    public override string Mnemonic => _isByteOperation ? "BIS.B" : "BIS";
    ...
    /// <summary>
    /// Returns a string representation of the BIS instruction.
    /// </summary>
